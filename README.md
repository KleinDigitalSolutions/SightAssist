...
|---|---|
| iOS | 18.0 oder höher |
| Gerät | iPhone 14 oder neuer (Basis-Modi auch auf älteren Geräten) |
| RAM | 6 GB (für lokale KI-Modelle; Basis-Modi brauchen weniger) |
...
> ⚠️ **Modus 3 aktuell deaktiviert** (`AppMode.vlmEnabled = false`). Wird nach erfolgreichem Test auf iPhone 14+ wieder aktiviert.

Wischen wechselt den Modus. VoiceOver sagt jeden Modus an. Beim ersten Start, ersten Scan und ersten Moduswechsel erklärt sich die App kurz selbst.
...
├── ContentView.swift              # Haupt-UI: Kamera, Modi, Gesten, erste-Hilfe
├── AppMode.swift                  # Modus-Enum + VLM-Feature-Flag
...
├── VisionModel.swift              # Gemma 4 E2B via MLX Swift (optional)
...
| Sprachausgabe | AVSpeechSynthesizer (Premium Anna) |
| Haptik | CoreHaptics |
| VLM (optional) | MLX Swift + Gemma 4 E2B |
...
| Geste | Aktion |
|---|---|
| **Einfach tippen** | Scannen (Modus 1) |
...
| `NSMicrophoneUsageDescription` | (vorbereitet) Spracheingabe für Fragen |
| `NSSpeechRecognitionUsageDescription` | (vorbereitet) On‑Device Spracherkennung |
